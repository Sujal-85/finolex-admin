            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                    <div className="p-6 border-b border-gray-100 bg-gray-50/50">
                        ...
                        <p className="text-gray-500 mt-1">Fill in the details for the new mess order</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            ...
                            <div className="col-span-1 md:col-span-2">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">Cost Per Head</label>
                                        <div className="relative">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            readOnly
                                            className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg font-semibold text-gray-700 outline-none"
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex justify-end gap-4 border-t border-gray-100 pt-6">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium shadow-sm transition-all transform active:scale-95 disabled:opacity-50"
                            >
                                <Save size={20} />
